const modalInformation = [
  {
    ...
    content: [
      'Continue reading to learn about some of this applications features or hit exit',
    ],
    url: '',
  },
  {
    ...
    content: [
      ...
      'Sorting algorithms place elements of a list in sorted order, in this case that is in increasing order of height / numeric value',
    ],
  ...
  },
  {
    ...
    content: [
      'To draw a wall click and drag on an empty cell in the grid. To erase walls click and drag on a filled cell. Walls are not explored by the pathfinding algorithms',
      'To draw a wall click and drag on an empty cell in the grid. To erase walls click and drag on a filled cell. Walls are not explored by the pathfinding algorithms.',
    ],
  ...
  },
  {
    ...
    content: [
      'The green node is the start node and the red node is the end node. You can move the start and end nodes by clicking and dragging their respective tiles.',
      'After the algorithm has finished feel free to drag the nodes around to visualize the algorithm instantly in varying positions',
    ],
  ...
  },
  {
    ...
    content: [
      `Dijkstra's Algorithm (weighted): The most fundamental pathfinding algorithm, it uses path costs to guarantee the shortest path. Out of these algorithms, it is the most expensive to perform and often checks the most nodes`,
  ...
  },
  {
    ...
    content: [
      'Use the navigation button in the top left corner to navigate the the sorting visualizer. Here you will be able to see some of the most common sorting algorithms in action,',
      'Use the sliders to change the size of the array and the speed of the algorithm',
    ],
